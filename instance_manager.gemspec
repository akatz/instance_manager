# -*- encoding: utf-8 -*-
require File.expand_path('../lib/instance_manager/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.summary       = %q{Search or list instances running your servers"}
  gem.homepage      = ""

  gem.files         = `git ls-files`.split($\)
  gem.executables   = gem.files.grep(%r{^bin/}).map{ |f| File.basename(f) }
  gem.test_files    = gem.files.grep(%r{^(test|spec|features)/})
  gem.name          = "instance_manager"
  gem.require_paths = ["lib"]
  gem.version       = InstanceManager::VERSION
